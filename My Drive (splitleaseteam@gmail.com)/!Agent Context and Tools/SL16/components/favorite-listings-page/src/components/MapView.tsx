...
const MapView: React.FC<MapViewProps> = ({
  ...
  useEffect(() => {
    ...
    listings.forEach(listing => {
      ...
      const priceHtml = `
        <div class="price-pin ${selectedListingId === listing.id ? 'selected' : ''}">
          <div class="price-pin-content">
            $${listing.pricingList.startingNightlyPrice}
          </div>
      ...
      const marker = L.marker(position, { icon: priceIcon })
        .addTo(mapRef.current);
      ...
      const popupHtml = `
        <div class="map-popup">
          ...
          <p class="map-popup-price">$${listing.pricingList.startingNightlyPrice}/night</p>
          <p class="map-popup-features">
            ${listing.features.qtyBedrooms} bed • ${listing.features.qtyBathrooms} bath
          </p>
        </div>
      `;
