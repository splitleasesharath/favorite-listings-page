...
import '../styles/SplitScheduleSelector.css';
...
interface SplitScheduleSelectorProps {
  onScheduleChange: (schedule: ScheduleSelection) => void;
  initialCheckIn?: string;
  initialCheckOut?: string;
}

const SplitScheduleSelector: React.FC<SplitScheduleSelectorProps> = ({
  onScheduleChange,
  initialCheckIn,
  initialCheckOut
}) => {
  ...
  const calculateSelectedDays = (checkIn: Date, checkOut: Date) => {
    const days: number[] = [];
